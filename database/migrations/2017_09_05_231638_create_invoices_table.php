...
class CreateInvoicesTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('invoices', function (Blueprint $table) {
            ...
            $table->string('product_three', 20)->nullable();
            ...
            $table->string('product_four', 20)->nullable();
            ...
            $table->string('product_five', 20)->nullable();
            ...
            $table->string('product_six', 20)->nullable();
            ...
            $table->string('product_seven', 20)->nullable();
