        ...
        data() {
            return {
                ...
                invoice: { // Invoices model and it's values
                    ...
                    // ========================== One
                    li_one: '', product_one: '', qty_one: 0, unit_one: 0, extended_one: 0,
                    // ========================== Two
                    li_two: '', product_tw: '', qty_two: 0, unit_two: 0, extended_two: 0,
                    //=========================== Three
                    li_three: '', product_three: '', qty_three: 0, unit_three: 0, extended_three: 0,
                    // ========================= Four
                    li_four: '', product_four: '', qty_four: 0, unit_four: 0, extended_four: 0,
                    // ========================= Five
                    li_five: '', product_five: '', qty_five: 0, unit_five: 0, extended_five: 0,
                    // ========================= Six
                    li_six: '', product_six: '', qty_six: 0, unit_six: 0,extended_six: 0,
                    // ========================= Seven
                    li_seven: '', product_seven: '', qty_seven: 0, unit_seven: 0, extended_seven: 0,
